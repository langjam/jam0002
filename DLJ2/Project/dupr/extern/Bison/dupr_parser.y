...
%nterm<dupr_pattern_execution_content> pattern_execution_content
%nterm<dupr_deamerreserved_plus__pattern_execution_content_stmt__> deamerreserved_plus__pattern_execution_content_stmt__
%nterm<dupr_pattern_execution_content_stmt> pattern_execution_content_stmt
...
pattern_execution_content:
	deamerreserved_plus__pattern_execution_content_stmt__ {
		auto* const newNode = new dupr::ast::node::pattern_execution_content({::dupr::ast::Type::pattern_execution_content, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
;
...
deamerreserved_plus__pattern_execution_content_stmt__:
	pattern_execution_content_stmt {
		auto* const newNode = new dupr::ast::node::deamerreserved_plus__pattern_execution_content_stmt__({::dupr::ast::Type::deamerreserved_plus__pattern_execution_content_stmt__, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
	| pattern_execution_content_stmt deamerreserved_plus__pattern_execution_content_stmt__ {
		auto* const newNode = new dupr::ast::node::deamerreserved_plus__pattern_execution_content_stmt__({::dupr::ast::Type::deamerreserved_plus__pattern_execution_content_stmt__, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1, $2 });
		$$ = newNode;
	}
;
...
pattern_execution_content_stmt:
	pattern_constructor_content_stmt {
		auto* const newNode = new dupr::ast::node::pattern_execution_content_stmt({::dupr::ast::Type::pattern_execution_content_stmt, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
;
...
pattern_name:
	VARNAME {
		auto* const newNode = new dupr::ast::node::pattern_name({::dupr::ast::Type::pattern_name, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { new dupr::ast::node::VARNAME({::dupr::ast::Type::VARNAME, ::deamer::external::cpp::ast::NodeValue::terminal, $1}) });
		$$ = newNode;
	}
;
...
pattern_constructor_encapsulation:
	LEFT_BRACKET deamerreserved_plus__pattern_constructor_content_stmt__ RIGHT_BRACKET {
	...
	| LEFT_PARANTHESIS deamerreserved_plus__pattern_constructor_content_stmt__ RIGHT_PARANTHESIS {
	...
	| LEFT_SQUARE_BRACKET deamerreserved_plus__pattern_constructor_content_stmt__ RIGHT_SQUARE_BRACKET {
