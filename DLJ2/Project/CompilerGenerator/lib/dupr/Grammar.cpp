...
pattern_constructor_terminate_STRING.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->STRING.Pointer() }));
...
AddObject(pattern_constructor_terminate_STRING);
