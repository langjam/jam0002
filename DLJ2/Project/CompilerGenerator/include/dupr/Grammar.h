...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::NonTerminal> pattern_execution_content;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::NonTerminal> deamerreserved_plus__pattern_execution_content_stmt__;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::NonTerminal> pattern_execution_content_stmt;
...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_execution_pattern_name_LEFT_BRACKET_pattern_execution_content_RIGHT_BRACKET;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> deamerreserved_plus__pattern_execution_content_stmt___pattern_execution_content_stmt;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> deamerreserved_plus__pattern_execution_content_stmt___pattern_execution_content_stmt_deamerreserved_plus__pattern_execution_content_stmt__;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_execution_content_deamerreserved_plus__pattern_execution_content_stmt__;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_execution_content_stmt_pattern_constructor_content_stmt;
...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_name_VARNAME;
...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_constructor_encapsulation_LEFT_BRACKET_deamerreserved_plus__pattern_constructor_content_stmt___RIGHT_BRACKET;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_constructor_encapsulation_LEFT_PARANTHESIS_deamerreserved_plus__pattern_constructor_content_stmt___RIGHT_PARANTHESIS;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> pattern_constructor_encapsulation_LEFT_SQUARE_BRACKET_deamerreserved_plus__pattern_constructor_content_stmt___RIGHT_SQUARE_BRACKET;
