...
namespace dupr::generation::cpp::templates
{
	...
	public:
		...
		ConvertEnumToName(::dupr::generation::cpp::templates::CPPTemplate::Type enumerationValue)
		{
	...
	public:
		struct VariableBase
		{
			...
			::dupr::generation::cpp::templates::CPPTemplate::Type type =
				::dupr::generation::cpp::templates::CPPTemplate::Type::Unknown;
		...
		{
			::dupr::generation::cpp::templates::CPPTemplate::ScopeType scope_type =
				::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::dupr::generation::cpp::templates::CPPTemplate::ScopeType scope_type_,
			...
			VariableScope(const char* text,
						  ::dupr::generation::cpp::templates::CPPTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Upper_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Lower_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Snake_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Slash_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(
					  ::dupr::generation::cpp::templates::CPPTemplate::ScopeType::DoubleColon_,
					  true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::dupr::generation::cpp::templates::CPPTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::dupr::generation::cpp::templates::CPPTemplate::ScopeType::
									  Variable_Field_Separator_,
								  true);
	...
	public:
		struct Variable_argument_ : public VariableScopes
		{
			...
			Variable_argument_(CPPTemplate* cpptemplate_,
		...
		struct Variable_argument_name_ : public VariableScopes
		{
			...
			Variable_argument_name_(CPPTemplate* cpptemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::argument_name_;
		...
		struct Variable_argument_type_ : public VariableScopes
		{
			...
			Variable_argument_type_(CPPTemplate* cpptemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::argument_type_;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(CPPTemplate* cpptemplate_, const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(
						 ...
						 "<set>\n#include <array>\n#include <algorithm>\n#include "
						 "<type_traits>\n#include <string>\n#include <memory>\n\n"),
					 GenerateVariable(cpptemplate_->function_prototype_->Variable_Field()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(cpptemplate_->function_->Variable_Field()),
					 GenerateVariable("\n\nint main()\n"), GenerateVariable("{"),
					 GenerateVariable("\n\tstd::cout << std::to_string(dupr_main()) << \""),
				...
				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("CPP")}));
				...
				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("dupr::generation::cpp::templates")}));
				...
				*static_cast<VariableBase*>(Target_language_) =
				...
				Target_language_->type =
					::dupr::generation::cpp::templates::CPPTemplate::Type::Scope;
			}
		...
		struct Variable_function_ : public VariableScopes
		{
			...
			Variable_function_(CPPTemplate* cpptemplate_,
							   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::function_;
		...
		struct Variable_function_name_ : public VariableScopes
		{
			...
			Variable_function_name_(CPPTemplate* cpptemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::function_name_;
		...
		struct Variable_function_prototype_ : public VariableScopes
		{
			...
			Variable_function_prototype_(CPPTemplate* cpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::function_prototype_;
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(CPPTemplate* cpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(CPPTemplate* cpptemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(CPPTemplate* cpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::left_curly_bracket_;
		...
		struct Variable_return_type_ : public VariableScopes
		{
			...
			Variable_return_type_(CPPTemplate* cpptemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::return_type_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(CPPTemplate* cpptemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(CPPTemplate* cpptemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(CPPTemplate* cpptemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::right_curly_bracket_;
		...
		struct Variable_statement_ : public VariableScopes
		{
			...
			Variable_statement_(CPPTemplate* cpptemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::dupr::generation::cpp::templates::CPPTemplate::Type::statement_;
	...
	public:
		CPPTemplate()
		{
			*argument_ = Variable_argument_(
				this, std::vector<VariableBase*>({GenerateVariable(argument_type_->This()),
												  GenerateVariable(" "),
												  GenerateVariable(argument_name_->This())}));
			...
			*function_ = Variable_function_(
				...
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t"), GenerateVariable(return_type_->This()),
					 GenerateVariable(" "), GenerateVariable(function_name_->This()),
					 GenerateVariable("("), GenerateVariable(argument_->Variable_Field()),
			...
			*function_prototype_ = Variable_function_prototype_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(return_type_->This()), GenerateVariable(" "),
						   GenerateVariable(function_name_->This()), GenerateVariable("("),
						   GenerateVariable(argument_->Variable_Field()), GenerateVariable(");")}));
